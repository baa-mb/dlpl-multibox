...
function set_strip_data(pin:number,matrixNr:number,matrixHwNr:number) {
    arr_neop_settings[matrixNr].pin=pin;
    arr_neop_settings[matrixNr].hwMatrix=arr_tech_matrix[matrixHwNr];
}
